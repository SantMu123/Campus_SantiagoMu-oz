...
# Convertir las filas filtradas a formato JSON
resultado_json = json.dumps(resultado_filtrado, indent=4)

# Mostrar las filas filtradas en formato JSON
print("Filas con edad mayor que", edad_minima, "en formato JSON:")
